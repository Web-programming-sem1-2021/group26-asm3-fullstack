    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="main">
                ...
                <h1 class="heading">Interpretation and Definitions</h1>
                <h2 class="heading">Interpretation</h2>
                <p>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            in this Agreement) refers to Group 26.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            ...
                            <a href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank">Terms and
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Group 26, accessible from
                            <a href="https://github.com/Web-programming-sem1-2021/Group26_Asm2_Javascript"
                                rel="external nofollow noopener"
                                target="_blank">https://github.com/Web-programming-sem1-2021/gGroup26_Asm2_Javascript</a>
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <h1 class="heading">Acknowledgment</h1>
                <p>
                ...
                <h1 class="heading">Links to Other Websites</h1>
                <p>
                ...
                <h1 class="heading">Limitation of Liability</h1>
                <p>
                ...
                <h1 class="heading">Governing Law</h1>
                <p>
                ...
                <h1 class="heading">Disputes Resolution</h1>
                <p>
                    If You have any concern or dispute about the Service, You agree to
                    first try to resolve the dispute informally by contacting the
                    Company.
                </p>
                <h1 class="heading">For European Union (EU) Users</h1>
                <p>
                    If You are a European Union consumer, you will benefit from any
                    mandatory provisions of the law of the country in which you are
                    resident in.
                </p>
                <h1 class="heading">United States Legal Compliance</h1>
                <p>
                ...
                <h1 class="heading">Severability and Waiver</h1>
                <h2 class="heading">Severability</h2>
                <p>
                ...
                <h1 class="heading">Translation Interpretation</h1>
                <p>
                    These Terms and Conditions may have been translated if We have made
                    them available to You on our Service. You agree that the original
                    English text shall prevail in the case of a dispute.
                </p>
                <h1 class="heading">Changes to These Terms and Conditions</h1>
                <p>
                ...
                <ul>
                    <li>By email: s3866617@rmit.edu.vn</li>
                </ul>
            </div>
            <footer>
