...
if (count($filteredProducts) > 0) {
            ...
            <a href="product-2.php">
                ...
                <div class="card-container">
                    <div class="product-detail">
                        ...
                        <h4 class="content-product-h3" style="font-family:Segoe UI; color:black; font-size:9.8pt; font-weight:normal"><b><?php echo $productMatchedStore[
                            $index
                        ]->name; ?></b></h4>
            </a>
            <p class="price money" style="font-family:Segoe UI; color:black; font-size:9pt; font-weight:normal "><b><?php echo $productMatchedStore[
                $index
            ]->price; ?> $</b></p>
    ...
    <?php }
     ...
     ?><h1 style="color:darkblue">No Featured Products found!</h1>
<?php
}
?>
