...
$storeJson = json_decode(productcsvToJson($fname));
...
<body>
  <header>
    ...
    <nav>
      <div id="logo">
        <a class="logo" href="./store-1.html">
          <h1 style="color:red; font: size 300px;"><?php
                                                    echo $storeJson[0]->name
                                                    ?></h1>
        </a>
      </div>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a href="./browse-products-by-categories-store1.html">Laptop</a>
                </li>
                <li>
                  <a href="./browse-products-by-categories-store1.html">Phones</a>
                </li>
                <li>
                  <a href="./browse-products-by-categories-store1.html">Cameras</a>
                </li>
                <li>
                  <a href="./browse-products-by-categories-store1.html">Tablets</a>
                </li>
                <li>
                  <a href="./browse-products-by-categories-store1.html">TV</a>
                </li>
              </ul>
            </li>
          </ul>
  ...
  <div class="row">
    ...
    <div class="product--col">
      <div class="product_inner">
        <img src="../storepages/images/iphone12.png" width="300" />
        <p>Iphone 12</p>
        <p>Price £1999</p>
        <p>Updated: 12/04/2021</p>
        <button><a href="./product-3.html">More Detail</a></button>
    ...
    <div class="product--col">
      <div class="product_inner">
        <img src="../storepages/images/camer.png" width="300" />
        <p>Conon 70D</p>
        <p>Price $950</p>
        <p>Updated: 12/04/2021</p>
    ...
    <div class="product--col">
      <div class="product_inner">
        <img src="../storepages/images/ipad.png" width="300" />
        <p>ipad 2021</p>
        <p>Price $1200</p>
        <p>Updated: 12/04/2021</p>
        <button><a href="./product-4.html">More Detail</a></button>
    ...
    <div class="product--col">
      <div class="product_inner">
        <img src="../storepages/images/tv.png" width="300" />
        <p>LED Smart TV</p>
        <p>Price $950</p>
        <p>Updated: 12/04/2021</p>
        <button><a href="./product-4.html">More Detail</a></button>
  ...
  <div class="carousel">
    ...
    <div class="item">
      <img src="../storepages/images/camer.png" alt="Avatar" style="width: 100%; padding: 0px" />
      <div class="card-container">
        <h4><b>Canon 70d</b></h4>
        <p>Price:$1760</p>
        <button><a href="./product-3.html">Add to basket</a></button>
    ...
    <div class="item">
      <img src="../storepages/images/iphone12.png" alt="Avatar" style="width: 100%; padding: 0px" />
      <div class="card-container">
        <br /><br /><br />
        <h4><b>iphone 12</b></h4>
        <p>Price:$1350</p>
    ...
    <div class="item">
      <img src="../storepages/images/tv.png" alt="Avatar" style="width: 100%; padding: 0px" />
      <div class="card-container">
        <br /><br /><br />
    ...
    <div class="item">
      <img src="../storepages/images/laptop.png" alt="Avatar" style="width: 100%; padding: 0px" />
      <div class="card-container">
        <br /><br /><br />
        <h4><b>Avendous Laptop</b></h4>
        <p>Price:$2100</p>
