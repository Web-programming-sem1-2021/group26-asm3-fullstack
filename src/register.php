...
<body>
    ...
    <section class="contact">
        <div class="form-box">
            <h2 style="text-align: center">Register Account <?php echo $_GET[
                "name"
            ]; ?>< /h2>

                    <?php echo isset($_GET["submit"]); ?> <form method="GET">
                        <div class="form-item">
                            <label for="email-address">Email address:<em id="email-error-message"></em></label>
                            <input type="email" name="email" id="email-address" value="<?php echo $email; ?>" required />
                        </div>
                        <div class=" form-item">
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" name='password' id="password" value="<?php echo $email; ?>" required />
                        </div>
                        <div class=" form-item">
                            <label for="retype-password">Retype password:<em
                                    id="retype-password-error-message"></em></label>
                                    ...
                                    <div class="form-item">
                                        ...
                                        <div class="form-item">
                                            <div class="form-group">
                                                <input name="date" type="checkbox" class="schedule-checkbox"
                                                    id="type1" />
                        ...
                        <div class="form-item">
                            ...
                            <input class="button button2" type="submit" name="submit" VALUE="Sign Up"
