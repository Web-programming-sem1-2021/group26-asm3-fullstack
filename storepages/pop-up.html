...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="popup-product.css" />
      ...
      <body>
        <div style="margin: 5%">
          ...
          >
            ...
            <p>Your order # is: 00000000</p>
            <p>
              You will receive an order confirmation email with details of your
              order and a link to track your process.
            </p>
            <img src="../icons/thank-you.svg" style="height: 5cm; width: 5cm" />
            <div class="btnArea center">
              <br /><br />
              <a href="./Basket.html"
                ><img
                  src="./images/Popup/goToBasket.png"
                  style="margin-right: 10px"
              /></a>
              <a href="#none" onclick="window.close()">
                <img src="./images/Popup/keepShopping.png"
              /></a>
            </div>
